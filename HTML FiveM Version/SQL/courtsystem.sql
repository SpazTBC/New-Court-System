...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2025 at 01:16 AM
...
CREATE TABLE `cases` (
  ...
  `hearing_status` enum('scheduled','completed','cancelled','postponed') DEFAULT 'scheduled',
...
ALTER TABLE `cases`
  ...
  ADD KEY `idx_hearing_status` (`hearing_status`),
  ADD KEY `idx_courtroom` (`courtroom`);
